...
public class Admin {
	...
	public String insertAdmin(String username, String password, String reports)
	{
		...
		try
		{
			...
			String query = " insert into admin(`adminID`,`adminUsername`,`adminPassword`,`adminReports`) values (?, ?, ?, ?)";
	...
	public String readAdmin()
	{
		...
		try
		{
			...
			while (rs.next())
			{
				...
				output += "<tr><td><input id='hidAdminIDUpdate'name='hidAdminIDUpdate' type='hidden' value='" + adminID+ "'>" + adminUsername + "</td>";
				...
				output += "<td><input name='btnUpdate'type='button' "
						...
						+ "value='Remove'class='btnRemove btn btn-danger'data-adminid='"+ adminID + "'>" + "</td></tr>";
			}
